...
object DFIntersectDemo {

  def main(args: Array[String]): Unit = {

    // Create instance of SparkConf
    val conf = new SparkConf().
      setAppName("Intersect Demo - Using DataFrame SQLContext").
      setMaster("local[2]")
    ...
    println("***** Problem Statement : Find out all common product ids sold on '25-Dec-2013' & '26-Dec-2013' *****")
    ...
    // Union all
    orders25dec2013OrderItemsJoinDF.
      intersect(orders26dec2013OrderItemsJoinDF).
      orderBy($"product_id").
      show(100)

    println("===== Approach 2 - SQL Way (join, intersect) =====")
    ordersDF.
