...
**(1) : Using Native Context (aka org.apache.spark.sql.SQLContext) :** With a SQLContext, application can create dataFrame in following ways:
  ...
  * **From Data Source:**
    ...
    * **_JSON File_**
    ...
    customersDF: org.apache.spark.sql.DataFrame = [customer_city: struct<string:string>, customer_email: struct<string:string>, customer_fname: struct<string:string>, customer_id: struct<int:bigint>, customer_lname: struct<string:string>, customer_password: struct<string:string>, customer_state: struct<string:string>, customer_street: struct<string:string>, customer_zipcode: struct<string:string>]
